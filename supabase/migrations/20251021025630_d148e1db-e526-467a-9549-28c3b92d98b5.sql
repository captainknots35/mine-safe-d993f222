-- Reseed all 5 lessons for Module 1 with complete verbatim content from MSHA Part 46 curriculum

-- Lesson 1: Welcome & Introduction to Mine Safety
...
# Part 1: Your Rights, Responsibilities, and the Chain of Command
...
-- Lesson 2: Anatomy of a Surface Mine
UPDATE public.lessons
SET content_data = jsonb_build_object(
  'content', '# Part 2: The Mine Environment: A Virtual Site Tour

## Arrival and Entry: Your First Steps onto the Mine Site

Imagine you are driving up to the mine for your first day. The first thing you will see is the mine entrance, clearly marked with signage. From the moment you enter the property, you are in an active work environment. Obey all posted speed limits and traffic signs, as haul trucks and other heavy equipment may be crossing the roads.

You will proceed to the mine office, which serves as the administrative hub. Here, you will sign in, meet your supervisor, and be introduced to key facilities. One of the most important features of the office area is the main Bulletin Board. This is not just a place for company announcements. By law, this board must display critical safety and health information, including MSHA citations, petitions for modifying safety standards, the mine rescue plan, and the official notification of who your miners'' representative is. Make it a habit to check this board regularly.

Other key facilities you will be shown include the first-aid station, emergency contact information, and the change rooms or "drys." Pay close attention to parking procedures and designated walkways to keep yourself safe in this active work environment.
...
| Highwall | Unexcavated cliff-like face; unstable ground hazard |
| Bench | Stepped terraces cut into highwall for equipment access |
| Berm | Safety barrier to prevent vehicles going over edge |
| Haul Road | Primary roads connecting pit to processing plant |
| Overburden | Topsoil/rock layer removed before mining |
| Stockpile | Cone-shaped material piles with angle of repose |
| Angle of Repose | Natural slope angle of stockpiled material |
| Processing Plant | Facility for crushing, screening, washing materials |
| Sump | Collection point for water at bottom of excavation |'
)
...
UPDATE public.lessons
SET content_data = jsonb_build_object(
  'content', '# Immersive Journey Through Mining Operations (30 CFR § 46.5(b)(1))
